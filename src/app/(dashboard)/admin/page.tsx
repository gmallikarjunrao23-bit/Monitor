            ...
            {pending.map((p) => (
              <div key={p.id} className="flex items-center justify-between rounded-card border border-degraded/30 bg-degraded/5 p-4">
                <div className="flex items-center gap-4">
                  <a href={p.screenshotUrl} target="_blank" rel="noreferrer" className="flex items-center gap-1 rounded-md border border-border bg-surface px-3 py-1.5 text-xs text-text-secondary hover:text-signal">
