...
import { LayoutDashboard, Activity, AlertTriangle, BarChart3, Globe, CreditCard, Settings, ShieldCheck, BookOpen } from "lucide-react";
  ...
  return (
    <aside className="glass flex h-screen w-60 shrink-0 flex-col border-r border-border">
      ...
      <div className="space-y-2 border-t border-border-subtle px-3 py-3">
        <Link
          href="/docs"
          className="flex items-center gap-3 rounded-md px-3 py-2 text-sm text-text-secondary transition-colors hover:bg-surface-hover hover:text-text-primary"
        >
          <BookOpen size={16} strokeWidth={2} />
          Docs
        </Link>
        <div className="flex items-center gap-2 px-3 text-xs text-text-muted">
